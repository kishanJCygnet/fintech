...
__( 'Try Email Subscribers Premium', 'email-subscribers' ),
...
__( 'Hope you are enjoying the premium features of Email Subscribers. It will expire on %s. You can anytime upgrade it to Pro.', 'email-subscribers' ),
__( 'Upgrade to Pro', 'email-subscribers' ),
/* translators: %d: Trial period in days */
...
__( 'Engagement score [PRO]', 'email-subscribers' ),
__( 'Bounce status [PRO]', 'email-subscribers' ),
