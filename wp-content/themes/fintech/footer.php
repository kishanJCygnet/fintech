   ...
   <!-- js -->
	...
	<script>
	  ...
	  document.addEventListener('wpcf7mailsent', function(e) {
		...
		} else if(e.detail.contactFormId == 172) {
	...
	<?php if($post_slug == '15-days-free-trial' || $post_slug == 'sign-up'){ ?>
	<script>		
		jQuery(document).ready(function(){
			jQuery('#buttonclicked').val("signup");
			jQuery('#password').removeAttr('disabled');
			jQuery('#password').show();
			jQuery('.password').show();
			jQuery('#buttonEye-password').removeAttr('disabled');
			jQuery('#buttonEye-password').show();
			jQuery('#message').attr('disabled','disabled');
			jQuery('#message').hide();
			<?php if($post_slug == 'sign-up'){ ?>
			jQuery("#submitbtn").attr('value', 'SIGN UP');
			jQuery("#formname").attr('value', 'Sign Up');
			<?php } else { ?>
			jQuery("#submitbtn").attr('value', 'Get 15 Days Free Trial');
			jQuery("#formname").attr('value', 'Get 15 Days Free Trial');
			<?php } ?>
	...
	<script>
		...
		jQuery('#contact_us').on('click',function(){
			jQuery('#buttonclicked').val("");
			jQuery('#password').attr('disabled','disabled');
			jQuery('#buttonEye-password').attr('disabled','disabled');
			jQuery('#password').hide();
			jQuery('.password').hide();
			jQuery('#buttonEye-password').hide();
			jQuery('#message').removeAttr('disabled');
			jQuery('#message').show();
			jQuery("#submitbtn").attr('value', 'Book Now');
			jQuery("#formname").attr('value', 'Book A Demo');
		});
